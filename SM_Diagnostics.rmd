...
For the parameters of interest for each model, we show the posterior trace, histogram, expected cumulative distribution (ECDF), and autocorrelation distribution. Following those are histograms of the autocorrelation (AC.####), potential scale reduction factor (PSRF), and effective sample size (ESS) values for all parameters of interest in the model. Finally for each model, we show the posterior predictive check distribution (PPD) expressed as the distribution of the deviation of the observed values from the PPD values.
